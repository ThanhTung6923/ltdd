...
class Positioned1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Position Example'),
      ),
      body: Stack(
        children: <Widget>[
          Positioned(
...
class RotatedBox1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
        title: Text('RotatedBox1 Example'),
    ),
    body: Center(
      child: RotatedBox(
          quarterTurns: 1,
...
class RotatedBox2 extends StatelessWidget {
  const RotatedBox2({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('RotatedBox2 Example'),
      ),
      body: Column(
        children: <Widget>[
          Container(
            height: 100,
            color: Colors.red,
            child: const Center(child: Text('Top Container')),
          ),
          Expanded(
            child: Container(
              color: Colors.green,
              child: const Center(child: Text('Expand Container')),
            ),
          ),
          Container(
            height: 100,
            color: Colors.blue,
            child: const Center(child: Text('Bottom Container')),
          ),
        ],
      ),
    );
